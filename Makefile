...
SRCS_BONUS		= $(addprefix ${FOLDER_BONUS}/, checker.c parsing.c print.c ft_atoi.c ft_split.c ft_substr.c moves.c check_stdin.c get_next_line.c get_next_line_utils.c)
OBJS		= ${SRCS:.c=.o}
